/*
 * Vendored, pinned dependency — Tone.js v15.0.4 (MIT license).
 * Source:    https://unpkg.com/tone@15.0.4/build/Tone.js
 * Retrieved: 2026-08-11
 * Committed verbatim (already minified upstream); do not edit by hand.
 * Loaded only on /clock/, only after explicit sound activation — see
 * assets/js/clock-audio.js and CLAUDE.md's Library-style "pinned
 * dependency through the project's normal dependency system" pattern
 * (this site has no npm/bundler, so "normal" means a committed,
 * version-pinned vendor file, same spirit as scripts/colorplan-source.json
 * and design/fonts/Nasalization-Rg.otf).
 */
